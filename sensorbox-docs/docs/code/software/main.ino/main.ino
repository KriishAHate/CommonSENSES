...
#define T_RH_setup_time 5000 // 5 seconds to setup T&RH sensor
...
void logError(int ErrorCode) {
  ...
  sprintf(errorMessage, "%02d%02d%02d%02d%02d:%02dE%02d",
...
void LTE_setup_message() {
  ...
  sprintf(Message, "%02d%02d%02d%02d%02d:%02dLTE Setup Done",
